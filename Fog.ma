...
//Name: Fog.ma
//Last modified: Mon, Oct 07, 2013 12:53:13 PM
//Codeset: 1252
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -5.4071059695653956e-015 3.6488824114999647e-016 26.702449950019908 ;
	setAttr ".rpt" -type "double3" -5.2200654145292047e-016 -3.6488737653713243e-016 
		2.0660936503961199e-016 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999979;
	setAttr ".coi" 26.702449950019908;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -5.9291125110183155e-015 8.6461286413635581e-022 0 ;
...
createNode fluidShape -n "fluidShape1" -p "fluid1";
	...
	setAttr ".ss" yes;
	setAttr ".cl[0].clp" 0;
	setAttr ".cl[0].clc" -type "float3" 0.482449 0.55629629 0.71899998 ;
	setAttr ".cl[0].cli" 1;
	setAttr ".coi" 2;
	setAttr -s 5 ".opa[0:4]"  0.22608696 0 1 1 0.57999998 1 0.46956521
		 0.12 1 0.64347827 0.16 1 0.86086959 0.25999999 1;
	setAttr ".opi" 2;
	setAttr ".t" -type "float3" 0.44274053 0.44274053 0.44274053 ;
	setAttr ".i[0].ip" 0;
...
connectAttr "fluid1.msg" "hyperLayout1.hyp[5].dn";
connectAttr "fluidShape1.msg" "hyperLayout1.hyp[6].dn";
connectAttr "fluidShape1SG.msg" "hyperLayout1.hyp[7].dn";
connectAttr "expression1.msg" "hyperLayout1.hyp[8].dn";
...
connectAttr "fluidShape1.msg" "expression1.obm";
