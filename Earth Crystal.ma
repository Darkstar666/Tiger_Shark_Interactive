...
//Last modified: Mon, Oct 14, 2013 03:09:42 PM
//Codeset: 1252
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -15.9808091597207 5.6332232593459555 -6.6320462233165465 ;
	setAttr ".r" -type "double3" -1.8000000000024325 6003.5999999999922 0 ;
...
createNode transform -n "Bottom" -p "group1";
	setAttr ".t" -type "double3" 0.43977785076129217 4.736502282341057 0.22175098918821184 ;
...
createNode transform -n "begginning_crystal:pPyramid1" -p "group1";
	...
	setAttr ".r" -type "double3" 17.219251613944344 -24.555025909268881 3.3883151526105575 ;
...
createNode transform -n "Small_crystal_group" -p "group1";
...
createNode transform -n "pPyramid5" -p "Small_crystal_group";
	setAttr ".t" -type "double3" -0.072695560066940557 8.5560756679193712 -0.45131546687431384 ;
...
createNode transform -n "pPyramid1" -p "Large_Crystals";
	...
	setAttr ".r" -type "double3" 174.02234872228374 -59.861104210494112 -155.65068220965125 ;
...
createNode transform -n "pPyramid12" -p "Large_Crystals";
	...
	setAttr ".r" -type "double3" -234.62746136599097 -68.635968325529731 208.21660961659828 ;
...
createNode transform -n "pPyramid13" -p "Large_Crystals";
	...
	setAttr ".r" -type "double3" -394.34490574139915 -36.868097662424361 346.00221546225242 ;
	setAttr ".s" -type "double3" 0.76954086724034376 1.0342176895318744 0.76954086724034376 ;
	setAttr ".rp" -type "double3" 0 -11.644008919250735 0 ;
	setAttr ".rpt" -type "double3" -5.7745472790619541 1.5561235483721114 0.68710710772185246 ;
	setAttr ".sp" -type "double3" 0 -11.413143430562148 0 ;
...
createNode transform -n "ambientLight1";
	setAttr ".t" -type "double3" 0 5.9718655552529025 -3.9477029744430068 ;
...
createNode phong -n "Crystal_texture";
...
connectAttr "begginning_crystal:polyMirror1.out" "begginning_crystal:pPyramidShape1.i"
		;
connectAttr "polySoftEdge2.out" "pPyramidShape2.i";
...
connectAttr "Crystal_texture.oc" "phong1SG.ss";
...
connectAttr "Crystal_texture.msg" "materialInfo2.m";
connectAttr "lambert2SG.pa" ":renderPartition.st" -na;
connectAttr "phong1SG.pa" ":renderPartition.st" -na;
connectAttr "Rock_texture.msg" ":defaultShaderList1.s" -na;
connectAttr "Crystal_texture.msg" ":defaultShaderList1.s" -na;
